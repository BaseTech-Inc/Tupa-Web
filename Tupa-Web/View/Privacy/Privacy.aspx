<%@ Page Title="Política de privacidade" Language="C#" MasterPageFile="~/View/Site.Master" AutoEventWireup="true" CodeBehind="Privacy.aspx.cs" Inherits="Tupa_Web.View.Privacy.Privacy" %>
    ...
    <div class="terms">
        <div class="list">
            ...
            <div class="list-item">
                <div class="list-item-wrapper container_wrapper">
                    <div class="title">
                        <h1>Política de Cookies Tupã</h1>
            ...
            <div class="list-item">
                <div class="list-item-wrapper container_wrapper">
                    ...
                    <div class="description">
                        <ul> 
                            <li> Se você criar uma conta connosco, usaremos cookies para o gerenciamento do processo de inscrição e administração geral. Esses cookies geralmente serão excluídos quando você sair do sistema, porém, em alguns casos, eles poderão permanecer posteriormente para lembrar as preferências do seu site ao sair. </li> 
                            <li> Utilizamos cookies quando você está logado, para que possamos lembrar dessa ação. Isso evita que você precise fazer login sempre que visitar uma nova página. Esses cookies são normalmente removidos ou limpos quando você efetua logout para garantir que você possa acessar apenas a recursos e áreas restritas ao efetuar login.</li>
                            <li> Este site oferece serviços de assinatura de boletim informativo ou e-mail e os cookies podem ser usados ​​para lembrar se você já está registrado e se deve mostrar determinadas notificações válidas apenas para usuários inscritos / não inscritos.</li> 
            ...
            <div class="list-item">
                <div class="list-item-wrapper container_wrapper">
                    ...
                    <div class="description">
                        <p>O usuário se compromete a fazer uso adequado dos conteúdos e da informação que o Tupã oferece no site e com caráter enunciativo, mas não limitativo:</p> 
            ...
            <div class="list-item">
                <div class="list-item-wrapper container_wrapper">
                    ...
                    <div class="description">
                        ...
                        <p>Esta política é efetiva a partir de <strong><%= DateTime.Now.Year.ToString() %></strong>.</p>
                    </div>
                </div>
            </div>
        </div>
